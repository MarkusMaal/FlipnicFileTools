namespace FlipnicFileToolGUI.Shaders;

public abstract class SukiUiShader
{
    // slightly modified version of SukiUI/Content/Shaders/Background/bubble.sksl
    public const string Background = """
                                     ...
                                     vec4 main(vec2 fragCoord) {
                                         ...
                                         float opacityLayer2 = 0.65;

                                         
                                         float iPrimaryOpacity = 1.1;
                                         iPrimaryOpacity = 0.52;
                                         vec3 iPrimaryWithOpacity = primaryMod * iPrimaryOpacity;

                                       
                                         float iAccentOpacity = 1; 
                                         iAccentOpacity = 0.9;
                                         vec3 iAccentWithOpacity = accentMod * iAccentOpacity;
