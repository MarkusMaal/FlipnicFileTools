...
{
    // https://stackoverflow.com/questions/22695723/create-valid-wav-file-header-for-streams-in-memory#comment34586659_22695723
    ...
    public static void WriteWavHeader(MemoryStream stream, bool isFloatingPoint, ushort channelCount, ushort bitDepth, int sampleRate, int totalSampleCount)
    {
        ...
        // RIFF header.
        // Chunk ID.
        stream.Write("RIFF"u8.ToArray(), 0, 4);

        // Chunk size.
        stream.Write(BitConverter.GetBytes(((bitDepth / 8) * totalSampleCount) + 36), 0, 4);

        // Format.
        stream.Write("WAVE"u8.ToArray(), 0, 4);



        // Sub-chunk 1.
        // Sub-chunk 1 ID.
        stream.Write("fmt "u8.ToArray(), 0, 4);
        ...
        // Sub-chunk 2.
        // Sub-chunk 2 ID.
        stream.Write("data"u8.ToArray(), 0, 4);
